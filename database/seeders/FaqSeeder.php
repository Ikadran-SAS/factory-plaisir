    ...
    public function run(): void
    {
        ...
        $faqs = [
            ...
            [
                ...
                'answer' => 'Oui ! Nous proposons plusieurs options <strong>végétariennes</strong> : le Veggie Smash Burger, le Veggie Bagel, le Super Bowl Quinoa, le Veggie Bowl et le Smoothie Bowl. Tous nos cheesecakes sont végétariens. Notre carte convient aux végétariens avec de nombreuses alternatives.',
                'sort_order' => 7,
            ],
            [
                'category' => 'allergenes',
                'category_label' => 'Allergènes & Régimes',
                'category_icon' => '🌿',
                'question' => 'Y a-t-il des options Halal et véganes ?',
                'answer' => 'Oui, nous proposons des options Halal certifiées (Halal Smash Burger, Chicken Avocado Bagel, Super Bowls) et des options véganes : <strong>Veggie Smash Burger</strong>, <strong>Super Bowl Quinoa</strong> et <strong>Smoothie Bowl</strong>.',
                'sort_order' => 8,
            ],
            [
                'category' => 'allergenes',
