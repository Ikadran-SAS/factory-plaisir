...
<urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9">
    ...
    <url><loc>{{ route('menu.burgers') }}</loc><lastmod>{{ now()->toDateString() }}</lastmod><changefreq>monthly</changefreq><priority>0.9</priority></url>
    ...
    <url><loc>{{ route('traiteur') }}</loc><lastmod>{{ now()->toDateString() }}</lastmod><changefreq>monthly</changefreq><priority>0.8</priority></url>
